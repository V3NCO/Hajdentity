...
def email_change_mail_template(old_email: str, new_email: str, username: str):
    return f"""
<!DOCTYPE html>
<html>
<head>
						...
						<tbody>
							<tr>
								<td valign="top" align="left" style="padding: 40px; word-break: break-word; overflow-wrap: break-word;">
									...
									<div style="padding-bottom:30px;">
										<div style="font-size:20px;line-height:150%;letter-spacing:-0.3px;font-family:Arial,Helvetica,sans-serif;">Hey {username},</div>
										<div style="font-size:20px;line-height:150%;letter-spacing:-0.3px;font-family:Arial,Helvetica,sans-serif;">Your email was changed from {old_email} to {new_email}</div>
									</div>
									<div style="padding-top:30px;">
